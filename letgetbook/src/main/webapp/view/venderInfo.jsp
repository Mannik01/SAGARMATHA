<div style="width: 50%; margin: auto;">
    ...
    <form name="form" ng-submit="vm.vendorRegister()" role="form">
    	 ...
    	 <div class="form-group" ng-class="{ 'has-error': form.companyName.$dirty && form.companyName.$error.required }">
            ...
            <input type="text" name="companyName" id="companyName" class="form-control" ng-model="vm.vendor.companyName" required />
        ...
        <div class="form-group" ng-class="{ 'has-error': form.street1.$dirty && form.street1.$error.required }">
            ...
            <input type="text" name="street1" id="street1" class="form-control" ng-model="vm.vendor.street1" required />
            <span ng-show="form.street1.$dirty && form.street1.$error.required" class="help-block">Street name is required</span>
        </div>
        <div class="form-group" >
            <label for="street2">Street2</label>
            <input type="text" name="street2" id="street2" class="form-control" ng-model="vm.vendor.street2"  />
        </div>
        ...
        <div class="form-group" >
            ...
            <input type="text" name="office_phoneNo" id="office_phoneNo" class="form-control" ng-model="vm.vendor.office_phoneNo"  />
        </div>
        <div class="form-group" >
            <label for="modile_phoneNo">Mobile Number</label>
            <input type="text" name="modile_phoneNo" id="modile_phoneNo" class="form-control" ng-model="vm.vendor.modile_phoneNo" />
        </div>
